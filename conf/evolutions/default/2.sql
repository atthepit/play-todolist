...
alter table task add constraint fk_task_user foreign key (user) references task_user (login) on delete cascade on update cascade;
create index ix_task_user_1 on task (user);
